...
#include <cruxus/engine/Game/objects/Sprite.hh>
#include <cruxus/engine/util/pointers.hh>
#include <cruxus/types/primitives.hh>
#include <cruxus/types/graphic.hh>
#include <cruxus/types/string_map.hh>
#include <cstddef>
#include <string>
#include <string_view>
#include <vector>
...
class CRX_DLL AnimatedSprite : public Sprite {
public:
